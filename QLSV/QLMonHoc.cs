...
namespace QLSV
{
    public partial class QLMonHoc : Form
    {
            ...
            private void btThemMH_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(conn);
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into MonHoc values(@Mamonhoc,@Tenmonhoc,@SoTC,@Hocky,@Machuyennganh)", con);
            cmd.Parameters.AddWithValue("Mamonhoc", txtMaMonHocThemMoi.Text);
            if (txtTenMH.Text != "")
            {
        ...
        private void btnsua_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(conn);
            con.Open();
            SqlCommand cmd = new SqlCommand("update  MonHoc set Tenmonhoc=@Tenmonhoc,SoTC=@SoTC,Hocky=@Hocky, Machuyennganh=@Machuyennganh where Mamonhoc=@Mamonhoc", con);
            cmd.Parameters.AddWithValue("Mamonhoc", txtMaMonHocThemMoi.Text);
            if (txtTenMH.Text != "")
            {
                cmd.Parameters.AddWithValue("Tenmonhoc", txtTenMH.Text);
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(conn);
            con.Open();
            SqlCommand cmd = new SqlCommand("delete from MonHoc where Mamonhoc=@Mamonhoc", con);
            cmd.Parameters.AddWithValue("Mamonhoc", txtMaMonHocThemMoi.Text);
